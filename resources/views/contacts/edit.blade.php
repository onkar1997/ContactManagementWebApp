            ...
            <div class="card p-4" style="width: 50rem; border-radius:5%; margin:10px auto;">
                <div class="card-body">
                    <div class="card-title mb-5">
                        <h1 class="text-center mb-2"  style="font-size:2em;">Edit Information</h1>
                        <hr>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group flex-nowrap">
                            ...
                            <input type="text" class="form-control" name="phone" id="phone" value="{{$contact->phone}}" aria-describedby="addon-wrapping">
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="note" name="note" rows="2">{{$contact->note}}</textarea>
                    </div>
                    <div class="mb-5">
